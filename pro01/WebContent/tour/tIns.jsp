		...
		<div style="width:1400px; margin:0 auto;">
			<nav aria-label="breadcrumb" style="text-align:right">
			  <ol class="breadcrumb">
			    ...
			    <li class="breadcrumb-item"><a href="${path0 }/GetTrafficList.do">교통편</a></li>
			    <li class="breadcrumb-item active" aria-current="page">교통편 등록</li>
			  </ol>
			</nav>
			<hr>
		</div>
		<div style="width:1400px; margin:0 auto;">
			...
			<form action="${path0 }/QuestionIns.do" method="post">
				...
				<div class="btn-group">
				  ...
				  <a href="${path0 }/GetTrafficList.do" class="btn btn-secondary">질문 및 답변 목록</a>
				</div>
			</form>
		</div>
	</section>
